...
def resnet(input_image, train_bn):
    ...
    # Third stage
    x = conv_block(C2, 3, [128, 128, 512], stage=3, block='a', train_bn = train_bn)
...
class MaskRCNN():
    ...
    def build(self, training=None):
        ...
        P2 = layers.Add()([
            ...
            layers.Conv2D(256, (1,1), padding='same')(C2)
        ])
    ...
    def train(self, train_dataset, val_dataset, epochs, batch_size, learning_rate, checkpoint_path ):
        ...
        with open(f"{batch_size}bs_{learning_rate}lr_accs.pkl", 'wb') as f:
            pickle.dump(history)
